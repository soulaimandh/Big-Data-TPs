...
public class Exercice_CountventParVilleAnnee_hdfs {
    public static void main(String[] args) throws InterruptedException {
        ...
        JavaDStream<String> dStreamLine = sc.textFileStream("./file");
        JavaDStream<String> dStreamword = dStreamLine.flatMap(s-> Arrays.asList(s.split(" ")).iterator());
        JavaPairDStream<String, Double> dStreamwordPair = dStreamword.mapToPair((vent)->new Tuple2<>(vent.
                split(" ")[0].split("/")[2]+" "+vent.split(" ")[1],
