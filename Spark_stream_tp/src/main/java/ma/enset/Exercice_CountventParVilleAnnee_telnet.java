...
public class  Exercice_CountventParVilleAnnee_telnet {
    public static void main(String[] args) throws InterruptedException {
        ...
        JavaPairDStream<String, Double> dStreamwordPair = dStreamword.mapToPair((vent)->new Tuple2<>(vent.split(" ")[0].
                split("/")[2]+" "+vent.split(" ")[1], Double.parseDouble(vent.split(" ")[3])));
